...
class ForumThreadRepository {
    ...
    private func parseThread(element: HTMLElement) -> ForumThread? {
        ...
        let thread = ForumThread(id: id!, title: title!.trimSpaces(), lastPostDate: lastPostDate!, author: author!, replies: replies!, views: views!, hasBiowareReply: hasBiowareReply, isSticky: isSticky)
