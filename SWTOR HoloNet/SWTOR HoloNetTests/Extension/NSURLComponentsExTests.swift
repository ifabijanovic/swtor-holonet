...
class NSURLComponentsExTests: XCTestCase {
    ...
    func testQueryValueForName_Success() {
        ...
        let value = NSURLComponents(string: url)!.queryValueForName("param")!
    ...
    func testQueryValueForName_MissingParameter() {
        let url = "http://www.holonet.test?param=value"
        let value = NSURLComponents(string: url)!.queryValueForName("otherParam")
    ...
    func testQueryValueForName_MultipleParameters() {
        ...
        let value1 = NSURLComponents(string: url)!.queryValueForName("param1")!
        let value2 = NSURLComponents(string: url)!.queryValueForName("param2")!
